...
<div class="div-action pull pull-left" style="padding-bottom:20px;">
					<button class="btn btn-success button1"  id="display" > <i class="glyphicon glyphicon-plus-sign"></i> Display </button>
				</div>

				<div class="div-action pull pull-right" style="padding-bottom:20px;">
					<a href="pdf.php">
					<button class="btn btn-danger"> <i class="glyphicon glyphicon-plus-sign"></i> Downloadpdf </button>
				</a>
...
{
table +=`<tr><td>${value.productImage}
</td>
...
<td><button type="button" class="btn btn-default" data-toggle="modal"  data-target="#editProductModal" id="user_${value.productid}" onclick="edit_user(${key})"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> </button></td>
        <td><button type="button" class="btnDelete" id="user_${value.productid}" onclick="delete_user(${key})"><i class="fa fa-trash"></i></button></td>
<tr>`;
});

      
            $("#manageProductTable").html(table); 
...
console.log(datas);
var e=datas[key]['category'];
console.log(e);
$('input[name="editBrandName"]').val(datas[key]['brand']);
$('input[name="editProductName"]').val(datas[key]['productname']);
$('input[name="editQuantity"]').val(datas[key]['quantity']);
$('input[name="editRate"]').val(datas[key]['rate']);  
$("#editCategoryName").val(e);
$('input[name="editProductStatus"]').val(datas[key]['status']);
